                ...
                if (like_btn.indexOf(post_id) >= 0) {
                    ...
                    temp_html = `<div class="card" id="${post_id}">
                                            ...
                                            <div>
                                                ...
                                                <a>
                                                    <img onclick="likes_psotid(${post_id}); likes_btn(${post_id})"class="likes likes_on" id="likes${post_id}" src="/static/like-icon-on.png">
                                                </a>
                                                <br>
                    ...
                    temp_html = `<div class="card" id="${post_id}">
                                            ...
                                            <div>
                                                <num style="float: right; margin-left: 3px;">${likes}</num>
                                                <a>
                                                    <img onclick="likes_psotid(${post_id}); likes_btn(${post_id})"class="likes likes_off" id="likes${post_id}" src="/static/like-icon-off.png">
                                                </a>
                                                <br>
                                                <p class="card_writer">${nickname}</p>
                                                <br>
